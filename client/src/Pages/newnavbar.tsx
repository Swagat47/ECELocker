      ...
      <div className="justify-between mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
        <div>
          <div className="flex items-center justify-between py-3 md:py-4 md:block ">
            <img
              className="object-contain h-full w-16 mt-2 left-0"
              src={nithlogo}
              alt=""
            />
            ...
            <div className="mt-0 space-y-0 md:hidden sm:inline-block">
              <Link to="/userProfile">
                <div className="px-0 py-1 border-spacing-1">
                  <img
                    className="object-contain h-10 w-10 float-right bg-our-blue"
                    src={userlogo1}
                    alt=""
                  />
                </div>
        ...
        <div className="hidden space-x-2 md:inline-block">
          <Link to="/userProfile">
            <div className="px-14 py-2 border-spacing-1">
              <img
                className="object-contain h-16 w-16 mt-2 bg-our-blue"
                src={userlogo1}
                alt=""
              />
            </div>
